<template>
  <div
    ...
    class="max-sm:tw-flex max-sm:tw-flex-wrap !tw-bg-[#eeeeee]"
  >
    <div class="tw-flex container tw-m-5 tw-justify-center tw-float-left">
      <div class="next-screen">
        ...
        <p class="tw-h-60">
          شرکت فناوری اهرم تولید کننده انواع نرم افزارهای تخصصی موبایل و وب
        </p>
      </div>
      ...
      <div class="screen-1">
        <div class="top">
          <h1>
            <span>شرکت فناوری اهرم</span>
            <br />
            <br />
            <p>طراحی سایت و اپلیکیشن</p>
          </h1>
        </div>
    ...
    <div class="tw-w-200 tw-mt-0 tw-justify-center max-sm:tw-float-left">
      <div class="tw-text-lg tw-p-10 md:tw-p-20">
...
.container {
  ...
  background-image: linear-gradient(315deg, #b8dbcb 0%, #f5f7fa 74%);
...
.screen-1 .top {
  ...
  width: 90%;
  height: 340px;
  background: url('../../assets/ahromlogoBlack.png');
...
.next-screen .header {
  width: 180px;
  height: 270px;
  background: url('../../assets/ahromlogo.png');
  border: 20px;
  background-size: cover;
